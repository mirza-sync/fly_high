...
class DiscoverDevices extends StatefulWidget {
  ...
  const DiscoverDevices({this.start = true});

  @override
  _DiscoverDevices createState() => new _DiscoverDevices();
}

class _DiscoverDevices extends State<DiscoverDevices> {
          ...
          return BluetoothDeviceListEntry(
            ...
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) {
                    print("Forward to Wifi List");
                    return DiscoverWifi(device: result.device);
                  },
                ),
              );
            },
